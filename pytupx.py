...
async def ytb(update: Update, context: ContextTypes.bot_data) -> None:
    ...
    try: 
        ...
        print(data.author)
        print('------------------------------------------------------')
        print(data.streaming_data['formats'][2]["url"])
        ...
        try:
            await update.message.reply_video(data.streaming_data['formats'][2]["url"])
        except:
        ...
        await update.message.reply_text("An error occurred, Try  https://tube.animexdrg.com/ !!") 
